...
class SemanticAnalyzer:
    ...
    def traverse_tree(self, tree):
        """Recorre el árbol sintáctico y muestra los nodos y tokens."""
        if isinstance(tree, Tree):
            print(f"Nodo: {tree.data}")
    ...
    def analyze(self, tree):
        ...
        print("**********************************************")
        print("Recorriendo el árbol sintáctico con recursión...")
        self.traverse_tree(tree)  # Llama a la función para recorrer el árbol
        print("**********************************************")
        ...
        print("Tree crudo:", tree)
        print("**********************************************")
        print("Tree children:", tree.children)
        print("**********************************************")
        print("programa_node:", programa_node)
        print("**********************************************")
